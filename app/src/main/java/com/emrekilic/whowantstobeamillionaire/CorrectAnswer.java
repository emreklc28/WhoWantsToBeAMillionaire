...
public class CorrectAnswer {
    ...
    public CorrectAnswer(String answer_a_correct, String answer_b_correct, String answer_c_correct, String answer_d_correct, String answer_e_correct, String answer_f_correct) {
